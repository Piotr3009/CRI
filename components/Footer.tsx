      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-base font-bold text-cri-charcoal">CIX</span>
            </div>
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-cri-steel">
              Construction Information Exchange. Evidence-backed client, payment and
        ...
        <div className="mt-10 border-t border-cri-border pt-6">
          <p className="text-xs leading-relaxed text-cri-steel">
            ...
            experiences. CIX does not make legal findings of wrongdoing and is not
            a blacklist. This platform does not provide legal advice.
          </p>
          <p className="mt-3 text-xs text-cri-steel">
            © {new Date().getFullYear()} CIX — Construction Information Exchange.
            Demo / MVP build.
          </p>
        </div>
      </div>
